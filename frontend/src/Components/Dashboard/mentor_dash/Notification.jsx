...
const MentorNotification = () => {
  ...
  const getStatusBadge = (status, hasReplied) => {
    if (hasReplied) {
      return <span className="px-3 py-1 text-xs font-medium rounded-full bg-green-100 text-green-700 border border-green-200 shadow-sm">Replied</span>;
    }
    if (status === 'unread' || !status) {
      return <span className="px-3 py-1 text-xs font-medium rounded-full bg-yellow-100 text-yellow-700 border border-yellow-200 shadow-sm">Unread</span>;
    }
    return <span className="px-3 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-700 border border-blue-200 shadow-sm">Read</span>;
  };
    ...
    <>
      {loading ? (
        <div className="p-12 text-center">
          ...
          <p className="mt-4 text-blue-600 font-medium">Loading messages...</p>
        </div>
      ) : messages.length === 0 ? (
        <div className="p-12 text-center">
          ...
          {messages.map((message, index) => (
            ...
            >
              ...
              {message.replayMessage && replyingTo?._id !== message._id && (
                <div className="ml-10 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border-l-4 border-green-400 shadow-sm">
              ...
              {replyingTo?._id !== message._id && (
                <div className="ml-10 mt-4">
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-200 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center gap-2"
                  >
              ...
              {replyingTo?._id === message._id && (
                <div className="ml-10 mt-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border-2 border-blue-200 shadow-inner">
                  <textarea
                    value={replyText}
                    onChange={(e) => setReplyText(e.target.value)}
                    placeholder="Type your reply here..."
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-white/80"
                    rows="4"
                  />
                  <div className="flex justify-end gap-3 mt-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg flex items-center gap-2"
                    >
                      {sendingReply ? (
                        <>
    ...
    <>
      {sentLoading ? (
        <div className="p-12 text-center">
          ...
          <p className="mt-4 text-purple-600 font-medium">Loading sent messages...</p>
        </div>
        ...
        <div className="divide-y divide-gray-100">
          {sentMessages.map((message, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2 flex-wrap">
                    ...
                    <span className="text-sm text-gray-400">•</span>
                    <span className="text-sm text-gray-600">{message.email}</span>
                    <span className="px-3 py-1 text-xs font-medium rounded-full bg-purple-100 text-purple-700 border border-purple-200 shadow-sm ml-auto">
                      {message.status}
                    </span>
                  </div>
                  <div className="ml-10">
              ...
              <div className="ml-10 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border-l-4 border-purple-400 shadow-sm">
                <div className="flex items-center gap-2 mb-2">
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex space-x-8">
            ...
            >
              ...
              {stats.unreadMessages > 0 && (
                <span className="absolute -top-1 -right-4 bg-gradient-to-r from-yellow-400 to-orange-400 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center shadow-sm">
        ...
        <div className="mt-6 flex flex-wrap gap-4 justify-center md:justify-start">
          <button
            ...
            className="px-6 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center gap-2 shadow-sm hover:shadow-md"
          >
