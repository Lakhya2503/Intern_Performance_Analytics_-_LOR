...
export default function MentorDashboard() {
  ...
  // Check token on component mount and set up interval
  useEffect(() => {
    const verifyToken = async () => {
      const isValid = await checkTokenExpiration();
      if (!isValid) {
        // Token check failed and was handled in AuthContext
        // No need to do anything here as AuthContext will redirect
      }
    };
