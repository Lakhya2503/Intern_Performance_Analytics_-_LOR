...
const ExecutionNotification = () => {
  ...
  // Subject options with teal color scheme
  const subjectOptions = [
    { value: 'lor', label: 'LOR', color: 'teal' },
    { value: 'interns', label: 'Interns', color: 'cyan' },
    { value: 'task', label: 'Task', color: 'emerald' },
    { value: 'dashboard controller', label: 'Dashboard Controller', color: 'teal' },
    { value: 'authentication', label: 'Authentication', color: 'cyan' },
  ...
  const getStatusBadge = (status) => {
    const statusMap = {
      'replied': { color: 'bg-emerald-100 text-emerald-700 border-emerald-200', label: 'Replied' },
      'unread': { color: 'bg-amber-100 text-amber-700 border-amber-200', label: 'Unread' },
      'read': { color: 'bg-teal-100 text-teal-700 border-teal-200', label: 'Read' }
    };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-xl hover:from-teal-600 hover:to-cyan-600 transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-2 self-start"
          >
        ...
        {showForm && (
          <div className="mb-8 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-fadeIn">
            <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-teal-50 via-cyan-50 to-emerald-50">
            ...
            <form onSubmit={handleSendMessage} className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-gray-50/50"
                ...
                {formData.subject === 'other' && (
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-gray-50/50"
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="5"
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-gray-50/50 resize-none"
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl hover:from-emerald-600 hover:to-teal-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg flex items-center gap-2"
                >
                  {sending ? (
                    <>
              ...
              {messages.map((message, index) => (
                ...
                >
                      ...
                      <div className="text-center">
                        ...
                        <div className="flex justify-center gap-3">
                          ...
                          <button
                            ...
                            disabled={deleting}
                            className="px-4 py-2 bg-gradient-to-r from-red-500 to-rose-500 text-white rounded-lg hover:from-red-600 hover:to-rose-600 transition-all duration-200 disabled:opacity-50 flex items-center gap-2"
                          >
                            {deleting ? (
                              <>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2 flex-wrap">
                        <div className="flex items-center gap-2">
                          <div className="w-10 h-10 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-md">
                  ...
                  {message.replayMessage && (
                    <div className="ml-12 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 border-l-4 border-emerald-400 shadow-sm mb-4">
