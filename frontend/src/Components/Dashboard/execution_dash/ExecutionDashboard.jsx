...
const ExecutionDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState('overview'); // This is for the inner dashboard tabs
  ...
  const handleGenerateLOR = (intern) => {
    navigate('/dashboard/ExecutionTeam', {
      state: {
        action: 'generate',
        internId: intern._id || intern.id,
  ...
  const deadlines = [
    ...
    { id: 'deadline-3', task: 'Weekly Reports', date: 'Friday', count: 8, color: 'teal', icon: BsGraphUpArrow },
  ];
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {quickStats.map((stat) => (
                  <div
                    ...
                    onClick={stat.label === 'LOR Requests' ? handleGenerateLOR :
